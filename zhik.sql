...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2013 at 01:06 PM
...
(2, 'About_System', 'شرکت ساختمانی ژیک در سال 1390 به جهت ایجاد ساختمان های شیک جهت رفاه حال اقشار و اصناف مختلف ایجاد \nگردیده است ، لذا با توجه به گستردگی اصناف بازار ساختمان خصوصا جهت اقشار مهندسی و پزشکی سخت گردید هست . اما با این حال ژِک توانسته است رضایت خاطر اقسام مختلف سلایق را جلب کند'),
...
(2, './slidespics/slide1.jpg', 'تست سعید حاتمی', 'این تست جهت حل مشکلات ویرایش می باشد', 3),
(3, './slidespics/seo.jpg', 'تست اسم عکس', 'تست توضیحات عکس سعید حاتمی', 1),
(4, './slidespics/browser.jpg', 'تست سابمیت', 'تست دوم', 1);
...
CREATE TABLE IF NOT EXISTS `works` (
  ...
  `pricetable` varchar(60) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `works` (`id`, `subject`, `image`, `body`, `link`, `sdate`, `fdate`, `catid`, `plan`, `pricetable`) VALUES
(100, 'تست اول', './workspics/desk.jpg', '<p>ک برنامه‌نویس قابلیت جالبی را در نسخه جدید سیستم عامل مک شرکت اپل موسوم به ماوریکس شناسایی کرده که تشخیص حضور کاربر در برابر رایانه را ممکن کرده است.\nبه گزارش فارس به نقل از اپل اینسایدر، حسگر حساس به نور رایانه های مک بوک پرو با استفاده از برنامه ای که در سیستم عامل ماوریکس نصب شده، می تواند حرکات کاربر را در برابر رایانه تشخیص دهد و در صورتی که عدم حضور وی در برابر رایانه طولانی شود، ابتدا نمایشگر خاموش شده و سپس هارددیسک نیز خاموش می گردد و رایانه در وضعیت sleep قرار می گیرد.\nپیش از این دوربین iSight رایانه های مک برای اقدامات عادی دیگری مورد استفاده قرار می گرفتند، اما این اولین بار است که چنین قابلیتی با استفاده از سیستم عامل های اپل بر روی رایانه های مذکور فعال شده است. جالب آنکه با تغییر وضعیت نور محیط قرارگیری رایانه، عملکرد سیستم هم بر مبنای آن متحول می گردد.\nگفتنی است حسگرهای نور محیطی در تمامی مدل های مک بوک پرو و همین طور مدل های اخیر رایانه های آی مک و نمایشگرهای پیشرفته و جدید این شرکت وجود دارد و لذا قابلیت یاد شده برای اکثر کاربران سیستم عامل مک قابل استفاده است. سیستم عامل ماوریکس که حدود 10 روز قبل عرضه شد، مورد استقبال گسترده کاربران قرار گرفته است.</p>', '', '2013-06-01 00:00:00', '2013-08-17 00:00:00', 5, '', ''),
(151, 'تست سابمیت', './workspics/kitchen.jpg', '<p>jbSJbjj</p>', '', '2013-06-26 19:07:42', '2013-07-03 19:07:42', 5, '', ''),
(152, 'تست کاری', './workspics/editslides.jpg', '<p>hk</p>', '', '2013-08-16 11:21:35', '2013-07-16 11:21:35', 6, '', ''),
(153, 'تست ورک', './workspics/users.jpg', ' در نسخه جدید سیستم عامل مک شرکت اپل موسوم به ماوریکس شناسایی کرده که تشخیص حضور کاربر در برابر رایانه را ممکن کرده است.\nبه گزارش فارس به نقل از اپل اینسایدر، حسگر حساس به نور رایانه های مک بوک پرو با استفاده از برنامه ای که در سیستم عامل ماوریکس نصب شده، می تواند حرکات کاربر را در برابر رایانه تشخیص دهد و در صورتی که عدم حضور وی در برابر رایانه طولانی شود، ابتدا نمایشگر خاموش شده و سپس هارددیسک نیز خاموش می گردد و رایانه در وضعیت sleep قرار می گیرد.\nپیش از این دوربین iSight رایانه های مک برای اقدامات عادی دیگری مورد استفاده قرار می گرفتند، اما این اولین بار است که چنین قابلیتی با استفاده از سیستم عامل های اپل بر روی رایانه های مذکور فعال شده است. جالب آنکه با تغییر وضعیت نور محیط قرارگیری رایانه، عملکرد سیستم هم بر مبنای آن متحول می گردد.\nگفتنی است حسگرهای نور محیطی در تمامی مدل های مک بوک پرو و همین طور مدل های اخیر رایانه های آی مک و نمایشگرهای پیشرفته و جدید این شرکت وجود دارد و لذا قابلیت یاد شده برای اکثر کاربران سیستم عامل مک قابل استفاده است. سیستم عامل ماوریکس که حدود 10 روز قبل عرضه شد، مورد استقبال گسترده ', 'www.mediateq.ir', '2013-07-23 11:13:56', '2013-08-22 11:13:56', 5, '', ''),
(154, 'تست ورک', './workspics/bedroom.jpg', ' در نسخه جدید سیستم عامل مک شرکت اپل موسوم به ماوریکس شناسایی کرده که تشخیص حضور کاربر در برابر رایانه را ممکن کرده است.\nبه گزارش فارس به نقل از اپل اینسایدر، حسگر حساس به نور رایانه های مک بوک پرو با استفاده از برنامه ای که در سیستم عامل ماوریکس نصب شده، می تواند حرکات کاربر را در برابر رایانه تشخیص دهد و در صورتی که عدم حضور وی در برابر رایانه طولانی شود، ابتدا نمایشگر خاموش شده و سپس هارددیسک نیز خاموش می گردد و رایانه در وضعیت sleep قرار می گیرد.\nپیش از این دوربین iSight رایانه های مک برای اقدامات عادی دیگری مورد استفاده قرار می گرفتند، اما این اولین بار است که چنین قابلیتی با استفاده از سیستم عامل های اپل بر روی رایانه های مذکور فعال شده است. جالب آنکه با تغییر وضعیت نور محیط قرارگیری رایانه، عملکرد سیستم هم بر مبنای آن متحول می گردد.\nگفتنی است حسگرهای نور محیطی در تمامی مدل های مک بوک پرو و همین طور مدل های اخیر رایانه های آی مک و نمایشگرهای پیشرفته و جدید این شرکت وجود دارد و لذا قابلیت یاد شده برای اکثر کاربران سیستم عامل مک قابل استفاده است. سیستم عامل ماوریکس که حدود 10 روز قبل عرضه شد، مورد استقبال گسترده ', 'www.mediateq.ir', '2013-07-23 11:13:56', '2013-08-19 11:13:56', 6, '', ''),
(155, 'تست سابمیت12', './workspics/test.jpg', '<p>hk</p>', '', '2013-08-16 11:21:35', '2013-07-30 11:21:35', 6, '', ''),
(156, 'تست ÷لان ها و قیمت ها', '../workspics/bedroom.jpg', '<p>همانطور که تا کنون متوجه شده اید، اپلیکیشن تلفن مربوط به اندرويد 4.4، ظاهری جدید پیدا کرده و مشخصه های مختلفی به آن اضافه شده. خبرها حاکی از این است که بخش تماس های اندروید هم تا اوایل سال 2014 به دیتابیس عظیمی از تصاویر مخاطبین مجهز می گردد. این دیتابیس چیزی نیست جز همان تصاویر پروفایل اشخاص در گوگل پلاس. به طوری که شماره تلفن تائید شده افراد در حساب های گوگل، با تصویر پروفایل گوگل پلاس آن ها جفت می شود.</p>\r\n<div>در این صورت هر وقت شما با فردی که تلفن اندرویدی دارد تماس بگیرید، تصویر پروفایل گوگل پلاس شما بر روی صفحه تماس های دریافتی او نقش می بندد، و صد البته این که هر گاه آن شخص با شما تماس بگیرد، شما هم تصویر پروفایل گوگل پلاس او را خواهید دید. این قابلیت، به ویژه، زمانی سودمند خواهد بود که شما شماره آن شخص را به لیست مخاطبین خود اضافه نکرده باشید، ولی چهره آن شخص را از روی تصویرش تشخیص دهید.</div>\r\n<div>این مشخصه جدید در اندروید به شما این امکان را می دهد که به جای این که دیگران برای شماره شما یک تصویر انتخاب کنند، خودتان تصویر مرتبط با شماره تان را در دستگاه های آن ها تعیین کنید. البته هنوز مشخص نیست که دقیقاً کدام یک از نسخه های اندروید از این ویژگی بهره خواهند برد. با این حال گوگل باز هم نشان داد که قصد دارد از حجم بسیار گسترده داده های کاربرانش بهترین استفاده را کرده، و با عرضه قابلیت هایی متکی به این داده های منحصر به فرد، و یکپارچه کردن خدمات متنوعش، سایر رقبا به چالش بکشاند</div>', '', '2013-11-06 13:04:35', '2013-11-11 13:04:35', 6, '', ''),
(157, 'تست سابمیت', '../newspics/apple.jpg', '<p>t=jo.n0ooyo</p>', '', '2013-11-07 13:38:16', '2013-10-29 13:38:16', 5, '', ''),
(158, 'تست سابمیت', '../newspics/internet.jpg', '<p>\\988</p>', '', '2013-11-11 13:40:12', '2013-11-13 13:40:12', 6, '', ''),
(159, 'تست سابمیت', '../newspics/chrome.jpg', '<p>6+</p>', '', '2013-11-12 13:41:30', '2013-11-07 13:41:30', 6, '', ''),
(160, 'تست سابمیت', '../newspics/apple.jpg', '<p> </p>\r\n<p>12554</p>', '', '2013-11-11 13:42:08', '2013-11-12 13:42:08', 6, '', ''),
(161, 'تست سابمیت', '../newspics/apple.jpg', '<p> </p>\r\n<p>12554</p>', '', '2013-11-11 13:44:24', '2013-11-12 13:44:24', 6, '', ''),
(162, 'تست ÷لان ها و قیمت ها', '../newspics/chrome.jpg', '<p>jhk</p>', '', '2013-11-12 13:57:07', '2013-11-14 13:57:07', 6, 'web-design-belfast.jpg', 'respic.png');
