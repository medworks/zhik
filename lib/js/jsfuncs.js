...
$(window).load(function(){
    $("a#filesbrowserbtn").click(function(){
        ...
        $('#filesbrowser').fadeIn(500).load('filebrowser.php?item'+findpage,function(){
            ...
            $(".cat-tabs-wrap-pic").hide();
            $(".cat-tabs-header-pic ul li:first").addClass("active").show();
            $(".cat-tabs-wrap-pic:first").show(); 
            $(".cat-tabs-header-pic ul li").click(function(){
                $(".cat-tabs-header-pic ul li").removeClass("active");
...
$(window).load(function(){
    $("a#planbrowserbtn").click(function(){
        var findpage = $(this).attr('name');
        $('#planbrowser').fadeIn(500).load('planbrowser.php?item'+findpage,function(){
            $('#planbrowser').css('display','block');
            
            $('#planexit').click(function(){
               $('#planbrowser').delay(500).fadeOut(1000);
            });

            //*******************************tabbed Boxes

            $(".cat-tabs-wrap-plan").hide();
            $(".cat-tabs-header-plan ul li:first").addClass("active").show();
            $(".cat-tabs-wrap-plan:first").show(); 
            $(".cat-tabs-header-plan ul li").click(function(){
                $(".cat-tabs-header-plan ul li").removeClass("active");
                $(this).addClass("active");
                $(".cat-tabs-wrap-plan").hide();
                var activeTab = $(this).find("a").attr("href");
                $(activeTab).fadeIn();
        ...
        $('#selectplanbuttton').click(function(){
            $('#planbrowser').delay(500).fadeOut(1000);
        });
    });
});
...
$(window).load(function(){
    $("a#pricebrowserbtn").click(function(){
        var findpage = $(this).attr('name');
        $('#pricebrowser').fadeIn(500).load('pricebrowser.php?item'+findpage,function(){
            $('#pricebrowser').css('display','block');
            
            $('#priceexit').click(function(){
               $('#pricebrowser').delay(500).fadeOut(1000);
            });

            //*******************************tabbed Boxes

            $(".cat-tabs-wrap-price").hide();
            $(".cat-tabs-header-price ul li:first").addClass("active").show();
            $(".cat-tabs-wrap-price:first").show(); 
            $(".cat-tabs-header-price ul li").click(function(){
                $(".cat-tabs-header-price ul li").removeClass("active");
                $(this).addClass("active");
                $(".cat-tabs-wrap-price").hide();
                var activeTab = $(this).find("a").attr("href");
                $(activeTab).fadeIn();
        ...
        $('#selectpricebuttton').click(function(){
            $('#pricebrowser').delay(500).fadeOut(1000);
        });
    });
});